...
public class CardinalSelection extends EffectState {
    ...
    public CardinalSelection(WeaponEffect referenceSource, int sourceSelectionOrder, SelectableType selectionType) {
    ...
    public void execute(WeaponCard invoker) {
        ...
        toSelect.addAll(reference.getOnCardinal(selectionType));
